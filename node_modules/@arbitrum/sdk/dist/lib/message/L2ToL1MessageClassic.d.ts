...
export declare class L2ToL1MessageClassic {
    ...
    static fromBatchNumber<T extends SignerOrProvider>(l1SignerOrProvider: T, batchNumber: BigNumber, indexInBatch: BigNumber): L2ToL1MessageReaderOrWriterClassic<T>;
...
export declare class L2ToL1MessageReaderClassic extends L2ToL1MessageClassic {
     ...
     * @returns
     */
    waitUntilOutboxEntryCreated(l2Provider: Provider, retryDelay?: number): Promise<void>;
    /**
...
export declare class L2ToL1MessageWriterClassic extends L2ToL1MessageReaderClassic {
    ...
    constructor(l1Signer: Signer, batchNumber: BigNumber, indexInBatch: BigNumber);
    /**
