...
export declare class L2ToL1MessageNitro {
    ...
    static fromEvent<T extends SignerOrProvider>(l1SignerOrProvider: T, event: EventArgs<L2ToL1TxEvent>): L2ToL1MessageReaderOrWriterNitro<T>;
...
export declare class L2ToL1MessageWriterNitro extends L2ToL1MessageReaderNitro {
    ...
    constructor(l1Signer: Signer, event: EventArgs<L2ToL1TxEvent>);
    /**
