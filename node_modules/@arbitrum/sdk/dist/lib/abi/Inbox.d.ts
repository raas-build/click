...
export interface InboxInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "uniswapCreateRetryableTicket", values: [
        string,
        BigNumberish,
        BigNumberish,
        string,
    ...
    decodeFunctionResult(functionFragment: "uniswapCreateRetryableTicket", data: BytesLike): Result;
...
export interface Inbox extends BaseContract {
    ...
    functions: {
        ...
        uniswapCreateRetryableTicket(to: string, l2CallValue: BigNumberish, maxSubmissionCost: BigNumberish, excessFeeRefundAddress: string, callValueRefundAddress: string, gasLimit: BigNumberish, maxFeePerGas: BigNumberish, data: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        uniswapCreateRetryableTicket(to: string, l2CallValue: BigNumberish, maxSubmissionCost: BigNumberish, excessFeeRefundAddress: string, callValueRefundAddress: string, gasLimit: BigNumberish, maxFeePerGas: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
